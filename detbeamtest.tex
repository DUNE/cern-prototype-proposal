...
A sample of 13k beam kaons with 1~GeV/c momentum are requested to provide 2k stopping $K^+$ track samples for PID studies (only 15\% of $K^+$ stop at 1~GeV/c).
%(85\% of $K^+$ interact at 1~GeV/c).
