...
the value of the
CP violating phase, $\delta_{CP}$, in the mixing matrix and
...
Fig.~\ref{fig:newlabel} shows the effect of a lepton energy scale 
...
\includegraphics[width=0.49\textwidth,height=6.0cm]{figures/APAT600_all_norm}
  \caption{
 (left) Photon background rejection % Background rejection 
versus electron identification efficiency for various energies, calculated for sample which pass the reconstruction. 
%The background is due to mid-identified photons.
The simulation was performed in APA design configuration (4.67~mm wire pitch, induction wires at $\pm$35.7$^{\circ}$ w.r.t. collection wires). (right) Photon background rejection versus electron identification efficiency
