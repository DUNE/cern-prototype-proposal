...
%\includegraphics[width=\textwidth,height=5.0cm]{figures/pid_curves}
  \caption{(right) ICARUS simulated track energy loss per unit length as a function of residual 
range for muons, pions, protons and kaons.  (right) Particle hypothesis curves obtained using a
neutral-net-based PID for
each particle type for a bin with residual range  6($\pm$1)~cm.
}
\label{fig:resrange}
\end{figure}
