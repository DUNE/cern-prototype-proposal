...
was used to determine probability functions for each particle hypothesis.
...
range for muons, pions, protons and kaons.  Neutral-net-based probability functions for
each particle type for a bin at residual range  6($\pm$1)~cm.
}
\label{fig:resrange}
\end{figure}
