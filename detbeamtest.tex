...
energy scale uncertainties will affect DUNE 
%shows the effect of 
...
This example assumes only a linear neutrino energy scale variation and does not consider more
complex (and more likely) scenarios or include correlations and background effects. 
