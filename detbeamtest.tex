...
Work to evaluate effect of all systematic uncertaintes in DUNE sensitivities is still in progress. 
...
Fig.~\ref{fig:global_escale_sens} from Ref.~\cite{DUNECDR}
shows the effect of various levels of neutrino energy on 
sensitivities. The nominal sensitivity assumes a 230-kt-MW-year 
...
neutrino interactions in the NuMI beam down to sub-GeV energies with a small-scale (??-ton) detector. 
While these samples are proving useful, they do now allow fully isolating 
...
Fig.~\ref{fig:containment} shows the simulated longitudinal and transverse containment for proton showers up to 10~GeV/c momentum.
...
%%
   ...
   \includegraphics[width=0.31\textwidth,height=3.9cm]{figures/protons_lcont_overlay}&
   \includegraphics[width=0.31\textwidth,height=3.9cm]{figures/protons_wcont_overlay}\\
