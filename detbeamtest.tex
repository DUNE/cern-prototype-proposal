...
The CERN prototype detector is designed from components that match exactly the DUNE far detector reference design for the first 10~kt detector module.
...
is achieved in those cases and for the above detector dimensions.
\begin{figure}[htp]
  \centering
  \begin{tabular}{ccc}
...
A large sample (10$^{6}$) 1 GeV protons represents a sample of low energy stopping protons over a 
