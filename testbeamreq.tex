...
\multicolumn{2}{|>{\columncolor[gray]{0.83}}c|}{\bf$\#$ of $\mu^-$ } \\ \hline  
\hiderowcolors
...
\showrowcolors 
\multicolumn{3}{|>{\columncolor[gray]{0.83}}c|}{\bf $P$ (GeV)} &\bf $\#$ of Spills&\multicolumn{2}{|>{\columncolor[gray]{0.83}}c|}{\bf Time (hrs)}&{\bf $\#$ of electron }\\
\hline
\hiderowcolors
...
In addition to the above samples with beam at the nominal position, we expect to take some additional data with the beam entering the TPC at different position and angles. The total estimated beam time needed to carry out the physics program in this proposal is about 4 to 6 weeks.
