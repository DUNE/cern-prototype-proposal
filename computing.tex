...
We plan to leverage these resources to process the data coming from the CERN prototype detector and beam test.
...
for the needs of the CERN prototype data analysis. This dCache instance is equipped with a XRootD ``door'' which makes it accessible to the outside world, subject
...
The CERN prototype detector effort will benefit from utilizing simulation toolkits, tracking and other reconstruction
