...
The Single Phase detector test at CERN will use a membrane tank technology which is supported by an outer steel structure.
...
off GAr to maintain the required purity which is measured by the detector in form of an electron lifetime.
