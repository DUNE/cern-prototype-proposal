...
The Single Phase TPC test at CERN will use a membrane tank technology to contain  725 tons of LAr, equivalent to about $520 m^3$. The design is based on a scaled up version of the LBNE 35-ton Prototype\cite{montanari_35ton} % add \cite{montanari_sbn_perf} if public access in docdb 9270 (AH)
...
\begin{figure}
\begin{center}
\includegraphics[width=.53\textwidth]{figures/cryostat-side-view} % (figure 2a)
\includegraphics[width=.42\textwidth]{figures/cryostat-westend-view}  %(figure 2b)
